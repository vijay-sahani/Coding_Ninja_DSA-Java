...
public class MirrorABinaryTree {
    public static void mirrorBinaryTree(BinaryTreeNode<Integer> root) {
        ...
        BinaryTreeNode<Integer> temp = root.left; // store the left node of the root
        root.left = root.right;// now update the left node with right of the root
        root.right = temp;// now update the right node with the previously stored left node
